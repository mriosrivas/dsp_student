...
class FIR():
    ...
    def band_filter(self, fc1, fc2, M, band_type='pass', method='spectral_inversion',
        ...
        if band_type == 'pass':
            return self.spectral_inversion(h)
        elif band_type == 'reject':
            return h
        else:
            raise Exception("incorrect band_type")
